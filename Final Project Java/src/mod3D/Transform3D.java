...
public class Transform3D {
	...
	void Scale(Sphere p, double s) { // Pass the method a Sphere and a scale
										// double
	...
	void Scale(Cube c, float s) { // Pass the method a cube and a scale double.

		c.side = s * c.side;

	}

	void Scale(Cylinder c, double s) {// Pass the method a cube and a scale
										// double
